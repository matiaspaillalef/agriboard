                  ...
                  <tr key={index} role="row">
                    {Object.keys(row).map((key, rowIndex) => {
                      ...
                      return key === "permissions" ? (
                        Object.keys(row[key]).map((permiso, idx) => (
                          <td
                            key={idx}
                            role="cell"
                    ...
                    {actions && (
                      ...
                      >
                        {!["Superadmin", "Admin", "User"].includes(
                          row.name
                        ) && (
                          <>
                            <button
            ...
            <div className="mb-3 grid grid-cols-1 gap-5 lg:grid-cols-1">
              ...
              <div className="mb-3 grid grid-cols-1 gap-5 lg:grid-cols-4">
                <div className="flex flex-col gap-3">
                  ...
                  <Switch 
                  id="switchRead" 
                  defaultChecked={ selectedUser ? selectedUser?.permissions?.read : false}
                  />
                </div>
                <div className="flex flex-col gap-3">
                  <label
                  ...
                  <Switch 
                  id="switchUpdate" 
                  defaultChecked={ selectedUser ? selectedUser?.permissions?.update : false}
                  />
                </div>
                <div className="flex flex-col gap-3">
                  <label
                  ...
                  <Switch 
                  id="switchClear" 
                  defaultChecked={ selectedUser ? selectedUser?.permissions?.clear : false}
                  />
                </div>
                <div className="flex flex-col gap-3">
                  <label
                  ...
                  <Switch 
                  id="switchCreate" 
                  defaultChecked={ selectedUser ? selectedUser?.permissions?.create : false}
                  />
                </div>
              </div>
            </div>
