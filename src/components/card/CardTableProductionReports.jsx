...
const CardTableManualHarvesting = ({
  ...
  const formatDate = (isoDate) => {
    ...
    // Fecha obtenida de la base de datos en formato string (sin ajuste)
    let dbDateTime = isoDate;

    // Separar la fecha y la hora
    let [date, time] = dbDateTime.split(' ');
    ...
    // Reformatear la fecha y hora en el formato deseado: DD-MM-YYYY HH:mm
