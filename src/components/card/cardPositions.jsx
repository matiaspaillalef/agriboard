...
const CardTablePositions = ({
  ...
  const onUpdateItem = async (data) => {
    ...
    try {
      ...
      // Manejo de errores
      setUpdateMessage(
        "Error al intentar actualizar el cargo. Inténtalo nuevamente."
      );
    }
  };
  ...
  const handlerRemove = async () => {
    ...
    try {
      ...
      if (deletePosition === "OK") {
        ...
        setUpdateMessage("Error al eliminar el cargo. Inténtalo nuevamente.");
      }
    } catch (error) {
      console.error(error);
      // Manejo de errores
      setUpdateMessage("Ocurrió un error al intentar eliminar el cargo.");
    }
  };
              ...
              >
                ...
                <div className="mb-3 grid grid-cols-1 gap-5 lg:grid-cols-1">
                  <div className="flex flex-col gap-3 ">
                    ...
                    />
                    {errors.name && (
                      <span className="text-red-500 text-xs mt-0 leading-none">
...
export default CardTablePositions;
