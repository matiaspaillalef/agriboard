...
import { getDataWorkers, getDataSquads } from "@/app/api/ManagementPeople";
                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      <select
                        ...
                        onChange={(e) => {
                          ...
                          setDataChangeGround(""); // Resetear campo cuando cambia la zona
                          setDataChangeSector(""); // Resetear sector cuando cambia la zona
                        }}
