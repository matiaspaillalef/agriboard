...
export const getDataWorkers = async (company_id, ground) => {
  try {
    const res = await fetch(
      `${URLAPI}/api/v1/filter/dashboard/dataWorkersCount/${company_id}/${ground}`,
      {
        method: "POST", // Asegúrate de que el método coincide con tu endpoint
        headers: {
          "Content-Type": "application/json",
...
export const getdataWorkersWeek = async (company_id, ground) => {
  try {
    const res = await fetch(
      `${URLAPI}/api/v1/filter/dashboard/dataWorkersWeek/${company_id}/${ground}`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const getDataDispatchDay = async (company_id, ground) => {
  try {
    const res = await fetch(
      `${URLAPI}/api/v1/filter/dashboard/dataDispatchGuideDay/${company_id}/${ground}`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const getDataVarietiesSeasonPercentage = async (company_id, ground) => {
  try {
    const res = await fetch(
      `${URLAPI}/api/v1/filter/dashboard/dataVarietySeasonPercentage/${company_id}/${ground}`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const getDataHumidityTemperatureSeason = async (company_id, ground) => {
  try {
    const res = await fetch(
      `${URLAPI}/api/v1//filter/dashboard/dataHumidityTemperatureSeason/${company_id}/${ground}`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
